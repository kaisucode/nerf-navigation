...
from utils import slim_ckpt, load_ckpt, load_transform_json
...
class NeRFSystem(LightningModule):
    def __init__(self, hparams, imgs, colmap_poses):
        super().__init__()
        print(hparams)
        self.save_hyperparameters(hparams)

        self.imgs = imgs['imgs']
        self.colmap_poses = colmap_poses['colmap_poses']
    ...
    def setup(self, stage):
        ...
        kwargs = {'root_dir': self.hparams.root_dir,
                  ...
                  'images': self.imgs,
                  'colmap_poses': self.colmap_poses}
