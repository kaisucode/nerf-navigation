...
class way_point_control:
    def __init__(self, robot_state_client, robot_command_client, frame_name=ODOM_FRAME_NAME):
    ...
    def relative_move(self, dx, dy, dyaw, stairs=False):
        ...
        out_tform_body = get_se2_a_tform_b(transforms, self.frame_name, BODY_FRAME_NAME)
        ...
        robot_cmd = RobotCommandBuilder.synchro_se2_trajectory_point_command(
            ...
            frame_name=self.frame_name, params=RobotCommandBuilder.mobility_params(stair_hint=stairs))
        end_time = 10.0
