...
class WasdInterface(object):
    ...
    def __init__(self, robot):
        ...
        self._command_dictionary = {
            ...
            ord('1'): self._plan_to_1,
            ord('2'): self._plan_to_2,
            ord('3'): self._plan_to_3,
            ord('4'): self._plan_to_4,
            ord('5'): self._plan_to_5,
            ord('6'): self._plan_to_6,
            ord('7'): self._plan_to_7,
            ord('8'): self._plan_to_8,
            ord('9'): self._plan_to_9
        }
    ...
    def _plan_to_1(self): 
        self._plan_robot(np.array(self.goals["1"]))
    def _plan_to_2(self): 
        self._plan_robot(np.array(self.goals["2"]))
    def _plan_to_3(self): 
        self._plan_robot(np.array(self.goals["3"]))
    def _plan_to_4(self): 
        self._plan_robot(np.array(self.goals["4"]))
    def _plan_to_5(self): 
        self._plan_robot(np.array(self.goals["5"]))
    def _plan_to_6(self): 
        self._plan_robot(np.array(self.goals["6"]))
    def _plan_to_7(self): 
        self._plan_robot(np.array(self.goals["7"]))
    def _plan_to_8(self): 
        self._plan_robot(np.array(self.goals["8"]))
    def _plan_to_9(self): 
        self._plan_robot(np.array(self.goals["9"]))
    ...
    def _plan_robot(self, goal=np.array([5.0, 0])): 
